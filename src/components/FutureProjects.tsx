      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {futureProjects.map((project) => (
            ...
            >
             <CardContent className="p-0"  style={{ height: '346px' }}>
